...
export class AppComponent {
  ...
  constructor(private routerExtensions: RouterExtensions,
    ...
    if (isAndroid) {
      Application.android.on(AndroidApplication.activityBackPressedEvent, this.handleBackPressedEvent, this);
      Application.android.on(AndroidApplication.activityPausedEvent, this.unregisterListeners, this);
    }
  }
