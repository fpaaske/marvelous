...
export class SeriesListComponent implements AfterViewInit {
  ...
  loadMoreItems() {
    ...
    this.api.getSeriesCollection(undefined, titleStartsWith, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, offset)
      .pipe(
